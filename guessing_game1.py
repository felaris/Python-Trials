...
# Guess the Number
import random
MAX_GUESSES = 5  # maximum number of guesses allowed MAX_RANGE = 20 # highest possible number
# Show introduction
...
def playOneRound():    # Choose random target
     target = random.randrange(1, MAX_RANGE + 1) #this is a global variable
